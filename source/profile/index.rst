...
* **Members:** A tab listing your community's administrators (including yourself). For each user the **name**, **username** (or **email** if using EU Login), **role**
...
you will also see here an **Additional properties** section to toggle the display of your organisation's
...
may be missing if use of this REST API is not enabled by your test bed's administrator.
